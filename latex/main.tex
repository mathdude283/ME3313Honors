...
\begin{document}
    ...
    \FloatBarrier\sethlcolor{lightgreen}
    \hl{Next, I took the list of angles for each input length and used these angles and the previously measured link lengths in }\cref{eq:scalar-equation1-1_derivative1,eq:scalar-equation1-2_derivative1,eq:scalar-equation2-1_derivative1,eq:scalar-equation2-2_derivative1,eq:rigid-geometry1_derivative1,eq:rigid-geometry2_derivative1,eq:scalar-equation1-1_derivative2,eq:scalar-equation1-2_derivative2,eq:scalar-equation2-1_derivative2,eq:scalar-equation2-2_derivative2,eq:rigid-geometry1_derivative2,eq:rigid-geometry2_derivative2}\hl{ to solve for angular velocity and angular acceleration of each point. The angular velocity and acceleration of Link BA is plotted in }\autoref{fig:linkba_angvel}\hl{ and }\autoref{fig:linkba_angacc}\hl{.}
    \FloatBarrier\begin{figure}[ht]
        \centering
